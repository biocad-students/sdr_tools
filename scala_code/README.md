...
- [ ] qhull посмотреть, что там за плешь, почему оно не работаить, ведь работало же, ааа! (обязательно)
- [ ] слайды
...
- [ ] сам монте-карло: посмотреть в других статьях тех же авторов, может, все-таки они используют какую-то хитрую схему (у меня совсем упрощенный)
